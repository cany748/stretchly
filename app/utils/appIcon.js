...
class AppIcon {
  constructor({ platform, paused, monochrome, inverted, darkMode, timeToBreakInTray, timeToBreak, reference }) {
  ...
  get trayIconFileName() {
    ...
    const timeToBreakInTrayString =
      this.paused || this.reference === "finishMicrobreak" || this.reference === "finishBreak" || !this.timeToBreakInTray
        ? ""
