...
window.onload = (event) => {
  ...
  document.querySelector("#close").onclick = (event) => ipcRenderer.send("finish-break", false);

  document.querySelector("#postpone").onclick = (event) => ipcRenderer.send("postpone-break");
